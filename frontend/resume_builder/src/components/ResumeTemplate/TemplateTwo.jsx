          ...
          >
            {resumeData.profileInfo.profilePreviewUrl
              ? <img
                ...
                />
              : <div
                  className="w-[140px] h-[140px] rounded-full flex items-center justify-center text-5xl"
          ...
          <div className="grid grid-cols-2 gap-6">
            {resumeData.certifications.map ((data, index) => (
              <CertificationInfo
                ...
                title={data.title}
                issuer={data.issuer}
                year={data.year ? new Date (data.year).getFullYear () : ''}
                bgColor={themeColors[2]}
              />
            ))}
          </div>
